...
function showPage(pageName) {
    ...
    // Toggle a class on the app shell so the header can react (e.g. shrink/compact on sub-pages)
    document.querySelector('.app-container').classList.toggle('on-subpage', pageName !== 'home');
